...
export const challenges: Challenge[] = [
  {
    ...
    stage: 1,
    status: "recommended",
    outcome: "Learn how learning-rate choices change convergence behavior.",
    workflow: ["Choose", "Run", "Compare", "Tune"],
  ...
  },
  {
    ...
    stage: 2,
    status: "new",
    outcome: "Compare dynamic learning-rate schedules through a physics-inspired experiment.",
    workflow: ["Select", "Launch", "Observe", "Optimize"],
    tags: ["schedules", "physics", "performance"],
    surface: "optimizer",
  },
  {
